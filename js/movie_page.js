...
/*Функция по нажатию на плюсик или минус открывающая или закрывающая описание*/
...
/*Функция по нажатию на плюсик или минус открывающая или закрывающая трейлер*/
...
/*Функция по нажатию на плюсик или минус открывающая или закрывающая фильм*/
...
/*Далее две функции для оформления самих плюсиков или минусов*/
...
/*Функция отправляющая аякс когда пользователь начнет смотреть фильм*/
function plus_view(movie_id,user_id) {
	args = 'choice=view' + '&' + 'movie_id=' + movie_id + '&' + 'user_id=' + user_id;
	ajaxSending(args);
}
/*Функция отправляющая аякс когда пользователь нажмёт на лайк*/
