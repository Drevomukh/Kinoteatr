...
/*Фукция выдвигающая форму для изменения пароля по нажатию на кнопку ПОМЕНЯТЬ ПАРОЛЬ*/
...
/*Фукция выдвигающая форму для изменения пароля по нажатию на кнопку ПОМЕНЯТЬ EMAIL*/
...
/*Функция выдвигающая блок с фильмами которые пользователь лайкал*/
...
/*Функция формирующая данные для изменения пароля*/
...
/*Функция отправляющая аякс для изменения пароля*/
...
/*Функция формирующая данные для изменения email*/
...
/*Функция отправляющая аякс для изменения EMAIL*/
