...
/*Далее функция которая проверяет длину пароля (чтобы пароль был >0 то есть чтобы пользователь хоть что-то ввёл) если тру то оптравляется аякс на авторизацию а если нет то ошибка*/
...
/*Отправка аякса на авторизацию если пароль >0*/
