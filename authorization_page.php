...
<body>
	...
	<!-- конец Шапки -->
	<!-- Далее блок с формой авторизации -->
	<div class="main_content">
		<div class="main_content_auth">
			...
			<div class="but_auth" onclick="auth_ajax_req()">
				<p>Войти</p>
			</div>
		</div>
	</div>
	<!-- конец  блока с формой авторизации -->
	<!-- Далее подключение к этой странице js файла -->
	<script type="text/javascript" src="js/auth_page.js?<?php echo time(); ?>"></script>
</body>
</html>
